...
import { getProjectsByGoal, projectDisplayTitle, projectEndDate, projectActualEndDate } from '../data.js?v=21';
import { DATA_PROGRAM_GOALS, GOAL_BY_SLUG, STATUS_ORDER } from '../config.js?v=21';
import { openProjectModal } from '../modal.js?v=21';
import { startLoading, showError } from '../ui-state.js?v=21';
